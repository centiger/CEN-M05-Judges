...
'🔗 연결 흐름 | 세겜 언약 → 여호수아 사망 → 신앙 계승 실패 → 우상숭배 → 사사시대',
...
'🌍 성경 전체 흐름 | 모세 → 드보라 → 사무엘 → 선지자 → 예수 그리스도',
...
'🔗 연결 흐름 | 미디안 압제 → 기드온 부르심 → 300용사 → 승리 → 영적 경계',
...
'🌍 성경 전체 흐름 | 기드온 → 남은 자 → 제자들 → 교회 → 하나님 나라',
...
'🔗 연결 흐름 | 나실인 → 블레셋 전쟁 → 들릴라 → 실패 → 마지막 기도',
...
'🌍 성경 전체 흐름 | 사사 → 실패 → 왕 요구 → 메시아 기대 → 예수 그리스도',
...
'🔗 연결 흐름 | 우상숭배 → 도덕적 붕괴 → 지파 갈등 → 공동체 위기 → 왕 요구',
...
'🌍 성경 전체 흐름 | 사사시대 → 사무엘 → 사울 → 다윗 → 메시아 → 예수 그리스도',

const HUBS = [
  {
    ...
    connections:[
'❓ 핵심질문 | 왜 사사시대의 위기는 다음 세대에서 시작되었는가?',
'💡 한 줄 핵심 | 신앙은 자동으로 계승되지 않으며 가르치고 기억해야 한다.',
'📖 사건의 의미 | 여호수아 이후 세대는 하나님의 구원을 잊고 가나안 문화에 동화되기 시작하였다.',
'🔗 연결 흐름 | 📜 세겜 언약 → 🛡️ 여호수아 사망 → 🐂 신앙 계승 실패 → 🐂 우상숭배 → ⚖️ 사사시대',
'🤔 생각해보기 | 나는 다음 세대에게 하나님을 기억하게 하고 있는가?'
],
integrated:[
'❓ 핵심질문 | 사사시대는 왜 반복적으로 무너졌는가?',
'💡 한 줄 핵심 | 하나님을 잊으면 공동체도 무너진다.',
'📖 구속사 의미 | 사사시대의 위기는 언약을 잊은 백성의 결과를 보여준다.',
'🌍 성경 전체 흐름 | 📜 언약 → ✅ 순종 → 🙌 축복 / 망각 → 🐂 우상숭배 → ⚖️ 심판',
'🤔 생각해보기 | 나는 하나님을 기억하는 삶의 습관을 가지고 있는가?'
],
  ...
  },
  {
    ...
    connections:[
'❓ 핵심질문 | 하나님은 어떤 사람을 사용하시는가?',
'💡 한 줄 핵심 | 하나님은 순종하는 사람을 통해 구원의 역사를 이루신다.',
'📖 사건의 의미 | 드보라와 바락의 승리는 인간의 힘이 아니라 하나님의 싸우심을 보여준다.',
'🔗 연결 흐름 | ⛓️ 압제 → 🔥 부르짖음 → ⚖️ 드보라 → 🌊 기손강 승리 → 🏆 평안',
'🤔 생각해보기 | 나는 하나님의 부르심에 순종으로 응답하고 있는가?'
],
integrated:[
'❓ 핵심질문 | 드보라의 승리는 성경 전체에서 무엇을 보여주는가?',
'💡 한 줄 핵심 | 하나님은 시대마다 구원의 도구를 세우신다.',
'📖 구속사 의미 | 드보라의 승리는 하나님의 구원이 특정 성별이나 조건에 제한되지 않음을 보여준다.',
'🌍 성경 전체 흐름 | 👶 모세 → ⚖️ 드보라 → 👴 사무엘 → 📣 선지자 → ✝️ 예수 그리스도',
'🤔 생각해보기 | 하나님은 지금 나를 어떤 도구로 사용하시길 원하실까?'
],
  ...
  },
  {
    ...
    connections:[
'❓ 핵심질문 | 하나님은 왜 군사를 줄이셨는가?',
'💡 한 줄 핵심 | 승리의 주체가 하나님이심을 드러내기 위함이다.',
'📖 사건의 의미 | 기드온의 300용사는 인간의 능력이 아니라 하나님의 능력을 보여준다.',
'🔗 연결 흐름 | ⛓️ 미디안 압제 → 🔥 기드온 부르심 → 📯 300용사 → 🏆 승리 → 📌 영적 경계',
'🤔 생각해보기 | 나는 내 능력보다 하나님의 능력을 의지하고 있는가?'
],
integrated:[
'❓ 핵심질문 | 적은 수의 승리는 무엇을 가르치는가?',
'💡 한 줄 핵심 | 하나님은 약함을 통해 강함을 드러내신다.',
'📖 구속사 의미 | 기드온의 이야기는 하나님의 구원이 사람의 힘이 아니라 은혜에 있음을 보여준다.',
'🌍 성경 전체 흐름 | ⚖️ 기드온 → 🌱 남은 자 → ⛪ 제자들 → ⛪ 교회 → 👑 하나님 나라',
'🤔 생각해보기 | 나는 부족함 속에서도 하나님을 신뢰하는가?'
],
  ...
  },
  {
    ...
    connections:[
'❓ 핵심질문 | 왜 강한 삼손은 무너졌는가?',
'💡 한 줄 핵심 | 능력보다 중요한 것은 하나님께 대한 순종이다.',
'📖 사건의 의미 | 삼손은 강했지만 거룩함을 잃어 실패한 사사였다.',
'🔗 연결 흐름 | ✂️ 나실인 → ⚔️ 블레셋 전쟁 → 💔 들릴라 → 🐂 실패 → 🙏 마지막 기도',
'🤔 생각해보기 | 나는 은사보다 순종을 더 중요하게 여기고 있는가?'
],
integrated:[
'❓ 핵심질문 | 삼손은 무엇을 기다리게 하는가?',
'💡 한 줄 핵심 | 불완전한 구원자는 완전한 구원자를 바라보게 한다.',
'📖 구속사 의미 | 삼손의 실패는 예수 그리스도와 같은 완전한 구원자의 필요성을 보여준다.',
'🌍 성경 전체 흐름 | ⚖️ 사사 → 🐂 실패 → 👑 왕 요구 → ✝️ 메시아 기대 → ✝️ 예수 그리스도',
'🤔 생각해보기 | 나는 나의 힘보다 하나님의 은혜를 의지하는가?'
],
  ...
  },
  {
    ...
    connections:[
'❓ 핵심질문 | 왜 이스라엘은 혼란에 빠졌는가?',
'💡 한 줄 핵심 | 하나님을 왕으로 인정하지 않을 때 공동체는 무너진다.',
'📖 사건의 의미 | 사사기의 결론은 영적 기준을 잃은 공동체의 모습을 보여준다.',
'🔗 연결 흐름 | 🐂 우상숭배 → 📌 도덕적 붕괴 → 🗺️ 지파 갈등 → 👥 공동체 위기 → 👑 왕 요구',
'🤔 생각해보기 | 내 삶의 진정한 왕은 누구인가?'
],
integrated:[
'❓ 핵심질문 | 사사기의 결론은 어디로 향하는가?',
'💡 한 줄 핵심 | 참된 왕에 대한 갈망은 메시아를 향한다.',
'📖 구속사 의미 | 사사기의 혼란은 사울과 다윗을 넘어 궁극적으로 예수 그리스도를 기다리게 한다.',
'🌍 성경 전체 흐름 | ⚖️ 사사시대 → 👴 사무엘 → 👑 사울 → 👑 다윗 → ✝️ 메시아 → ✝️ 예수 그리스도',
'🤔 생각해보기 | 나는 예수님을 삶의 왕으로 모시고 있는가?'
],
